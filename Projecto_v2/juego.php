	...
	<header>
		<div class="conect">
			<?php if(!empty($user)): ?>
			      <?= $user['email']; ?>
				<div class="conecta">
			      <a href="logout.php">DESCONEXIÓN</a>
			    <?php else: ?>
				<div class="conecta">
			      <a href="login.php">CONEXIÓN</a>
			    <?php endif; ?>
			</div>
		</div>
		<div class="nav">
  			<div class="navx"><a href="index.html">INICIO</a></div>
 			<div class="navx" id="selec"><a href="juego.html">JUEGO</a></div>
 			<div class="navx"><a href="ranking.html">RANKING</a></div>
 			<div class="navx"><a href="proyecto.html">PROYECTO</a></div>
		</div>	
	</header>
