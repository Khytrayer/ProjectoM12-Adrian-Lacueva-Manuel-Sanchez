	...
	<header>
		<div class="conect">
			<?php if(!empty($user)): ?>
			      <?= $user['email']; ?>
				<div class="conecta">
			      <a href="/proyecto/login/logout.php">DESCONEXIÓN</a>
			    <?php else: ?>
				<div class="conecta">
			      <a href="/proyecto/login/login.php">CONEXIÓN</a>
			    <?php endif; ?>
			</div>
		</div>
		<div class="nav">
  			<div id="home"><a href="/proyecto/login/logout.php"><img src="imagenes/logofoot.png" height="50px"></a></div>
		</div>	
	</header>
